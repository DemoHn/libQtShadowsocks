...
QT_MOC_LITERAL(1, 18, 4), // "info"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 18), // "onSocketAReadyRead"
QT_MOC_LITERAL(4, 43, 18) // "onSocketBReadyRead"

    },
    "QSS::SocketStream\0info\0\0onSocketAReadyRead\0"
    "onSocketBReadyRead"
};
...
void QSS::SocketStream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onSocketAReadyRead(); break;
        case 2: _t->onSocketBReadyRead(); break;
        default: ;
        }
        ...
        {
            typedef void (SocketStream::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SocketStream::info)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void QSS::SocketStream::info(const QString & _t1)
{
